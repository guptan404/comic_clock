                        ...
                        child: Column(
                          ...
                          children: [
                            Text("${jokeProvider.curentStreak} ",
                              style: AppConstants.comicSubHead.copyWith(fontSize: 30,fontWeight: FontWeight.bold,color: Colors.black),),
                           // AppIcons.bomb,
                            Text('Giggle', style:
                            AppConstants.comicSubHead.copyWith(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.black),),
                              Text('Streak', style:
                              AppConstants.comicSubHead.copyWith(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.black))
                          ],
                        ),
                          ...
                          child: Column(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text(
                                  'Theme',
                                  style: AppConstants.comicSubHead.copyWith(color: kdarkTextColor),
                                ),
                              ),
                              Row(
                                children: [
